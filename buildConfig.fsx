...
let buildConfig =
 ...
 { BuildConfiguration.Defaults with
    ProjectName = "Yaaf.Xmpp.IM"
    CopyrightNotice = "Yaaf.Xmpp.IM Copyright © Matthias Dittrich 2015"
    ProjectSummary = "A full rfc XMPP.IM library."
    ProjectDescription = "A full XMPP.IM implementation strictly following the RFC specification."
    ProjectAuthors = ["Matthias Dittrich"]
    NugetTags =  "fsharp csharp xmpp im library"
    PageAuthor = "Matthias Dittrich"
    GithubUser = "matthid"
    Version = release.NugetVersion
    NugetPackages =
      [ "Yaaf.Xmpp.IM.nuspec", (fun config p ->
          { p with
